...
//
//! @param[out] dst_buf_ptr: The buffer into which the result will be written
//! @param[out] dst_buf_len: Length of the buffer into which the result will be written
//! @param[in] src_ptr:      The byte string to be encoded
//! @param[in] src_len:      Length of the byte string to be encoded
//! @returns                 A struct containing the success status of the encoding operation and the length of the result (that was written to dst_buf_ptr)
...
//! @param[out] dst_buf_ptr: The buffer into which the result will be written
//! @param[out] dst_buf_len: Length of the buffer into which the result will be written
//! @param[in] src_ptr:     The byte string to be decoded
//! @param[in] src_len:     Length of the byte string to be decoded
//! @returns                 A struct containing the success status of the decoding operation and the length of the result (that was written to dst_buf_ptr)
